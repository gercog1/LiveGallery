        ...
        <figure style={{ flexBasis: 'none', height: 200, display: 'inline-block' }} className="grid-figure">
          <div className="row">
            ...
            <div className="col-md-1">
              <figcaption >
                <button onClick={openModal} style={{ color: '#4286f4', textAlign: 'center', width: 50, height: 50, marginTop: 10 }} className="font-bold" ><i style={{ fontSize: 20 }} className="glyphicon glyphicon-plus" /></button>
